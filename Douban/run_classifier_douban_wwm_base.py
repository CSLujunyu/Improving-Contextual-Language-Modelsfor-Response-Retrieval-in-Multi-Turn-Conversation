...
from Model.modeling_chatbert import BertConfig, BertForSequenceClassification
...
def main():
    ...
    parser.add_argument("--data_dir",
                        default='/hdd/lujunyu/dataset/douban/',
                        type=str,
                        required=False,
    ...
    parser.add_argument("--output_dir",
                        default='/hdd/lujunyu/model/douban_wwm_base_chatbert/',
                        type=str,
                        required=False,
    ...
    train_dataset = DoubanDatasetBase(
        file_path=os.path.join(args.data_dir, "train.txt"),
        max_seq_length=args.max_seq_length,
        tokenizer=tokenizer
    )
    eval_dataset = DoubanDatasetBase(
