...
def main():
    ...
    parser.add_argument("--init_checkpoint",
                        default='/hdd/lujunyu/model/chatbert/ubuntu_albert/model.pt',
                        type=str,
    ...
    model = AlbertForSequenceClassification.from_pretrained(args.init_checkpoint, config=bert_config)
    model.to(device)
    ...
    for input_ids, input_mask, segment_ids, label_ids in tqdm(test_dataloader, desc="Step"):
        ...
        with torch.no_grad():
            tmp_test_loss, logits = model(input_ids, token_type_ids=segment_ids, attention_mask=input_mask, labels=label_ids)
