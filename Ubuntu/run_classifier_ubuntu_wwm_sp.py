...
reverse_order = False
sa_step = False
BERT_BASE_DIR = '/hdd/lujunyu/dataset/bert/wwm_uncased_L-24_H-1024_A-16/'
...
def main():
    ...
    parser.add_argument("--output_dir",
                        default='/hdd/lujunyu/model/chatbert/ubuntu_wwm_sp/',
                        type=str,
                        required=False,
    ...
    if args.data_augmentation:
        train_dataset = UbuntuDatasetBase(
    ...
    eval_dataset = UbuntuDatasetBase(
