...
def main():
    ...
    parser.add_argument("--init_checkpoint",
                        default='/hdd/lujunyu/model/chatbert/ubuntu_base_sp/model.pt',
                        type=str,
    ...
    test_dataset = UbuntuDatasetForSP(
    ...
    model = BertForSequenceClassification(bert_config).from_pretrained(args.init_checkpoint, config=bert_config)
    model.to(device)
