...
from Utils.DataLoader import DoubanDatasetForSP
from transformers import BertConfig, BertTokenizer, BertForSequenceClassification
from Utils.douban_evaluation import evaluate
...
def main():
    ...
    parser.add_argument("--output_dir",
                        default='/hdd/lujunyu/model/chatbert/douban_without_pretraining/',
                        type=str,
                        required=False,
    ...
    test_dataset = DoubanDatasetForSP(
    ...
    model = BertForSequenceClassification.from_pretrained(os.path.join(args.output_dir, 'model.pt'), config=bert_config)
    model.to(device)
    ...
    visualize_bad_cases(
        ...
        output_file_path=os.path.join(args.output_dir, 'test_cases.txt')
    )
